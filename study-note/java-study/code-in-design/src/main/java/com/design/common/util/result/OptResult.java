...
public class OptResult {
    ...
    public static <T> Map saveResult(int total, int successed, int fieled, List<T> fieldList) {
    ...
    public static <T> Map deleteResult(int total, int successed, int fieled, List<T> fieldList) {
        Map<String, Object> result = new HashMap();
    ...
    public static <T> Map selectResult(List<T> list) {
        Map<String, Object> result = new HashMap();
    ...
    public static <T> Map selectResult(List<T> list, Pageable pageable) {
        Map<String, Object> result = new HashMap();
